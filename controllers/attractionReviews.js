function handelAttractionReview(review){
    if(review != "None"){
        ...
        while( curMatch = rxp.exec( str ) ) {
           ...
           // console.log("10")
            ...
            secondvariable = "', 'time-typeoftrip':";
            ...
            firstvariable = "'time-typeoftrip': '";
            secondvariable = "'";
            var time_of_trip = curMatch[1].match(new RegExp(firstvariable + "(.*)" + secondvariable));
            var reviews = {
...
module.exports = {handelAttractionReview}